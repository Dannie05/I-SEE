export default function SignUp(){
  return <div className="ease-in-out duration-700 overflow-none before:absolute inset-0 min-h-screen dark:bg-black dark:text-silver pb-8 signupPage">
    awaiting build
  </div>
}
...
//         </span>
//       </p>
//       <div className="mb-10 flex flex gap-2 text-3xl items-center justify-center icons">
